...
public class ItemCodeLock extends Item {
	...
	public ItemCodeLock(int par1) {
		...
		this.setItemName("PrivacyCraftItemCodeLock");
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		...
		Block block = PrivacyCraft.stoneCodeLockBlock;
		...
		if (par1ItemStack.stackSize == 0) {
			...
			return false;
		} else if (par5 == 255 && Block.blocksList[block.blockID].blockMaterial.isSolid()) {
			return false;
		} else if (par3World.canPlaceEntityOnSide(block.blockID, par4, par5, par6, false, par7, par2EntityPlayer)) {
			int var13 = this.getMetadata(par1ItemStack.getItemDamage());
			int var14 = block.func_85104_a(par3World, par4, par5, par6, par7, par8, par9, par10, var13);

			if (placeBlockAt(par1ItemStack, par2EntityPlayer, par3World, par4, par5, par6, par7, par8, par9, par10, var14, block)) {
